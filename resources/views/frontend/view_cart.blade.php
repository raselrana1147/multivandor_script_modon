                            ...
                            <div class="form-group">
                               {{--  @if (\App\Addon::where('unique_identifier', 'otp_system')->first() != null && \App\Addon::where('unique_identifier', 'otp_system')->first()->activated)
                                ...
                                @endif --}}
                                 ...
                                 <input type="text" class="form-control h-auto form-control-lg {{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ old('email') }}" placeholder="{{  translate('Phone') }}" name="phone" required="">
                            </div>

                            <div class="form-group">
                                <input type="password" name="password" class="form-control h-auto form-control-lg" placeholder="{{ translate('Password')}}" required>
                            </div>
