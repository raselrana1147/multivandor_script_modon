        ...
        <div class="row">
            <div class="col-xxl-5 col-xl-6 col-md-8 mx-auto">
                <div class="bg-white rounded shadow-sm p-4 text-left">
                    ...
                    <p class="mb-4 opacity-60">{{translate('Enter your phone number to recover your password.')}} </p>
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ old('phone') }}" placeholder="{{ translate('Phone') }}" name="phone">
                        </div>
                        <div class="form-group text-right">
                            <button class="btn btn-primary btn-block" type="submit">
                                {{ translate('Send Mobile OTP') }}
                            </button>
                        </div>
                    </form>
                    <div class="mt-3">
