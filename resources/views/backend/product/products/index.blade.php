                ...
                <thead>
                    <tr>
                        ...
                        @if($type == 'Seller' || $type == 'All')
                         <th data-breakpoints="lg">{{translate('Owner Info')}}</th>
                        @endif
                    ...
                    <tr>
                        ...
                        @if($type == 'Seller' || $type == 'All')
                            <td>
                                ...
                                <p>Type: {{ $product->user->user_type }}</p>
                            </td>
                        @endif
                        <td>
                        ...
                        <td class="text-right">
                            ...
                            <a class="btn btn-soft-warning btn-icon btn-circle btn-sm" href="{{route('products.duplicate', ['id'=>$product->id, 'type'=>$type]  )}}" title="{{ translate('Duplicate') }}">
                             ...
                             <a href="javascript:;" class="btn btn-soft-warning btn-icon btn-circle btn-sm add-commission"  product_id="{{$product->id}}" title="{{ translate('Commission') }}">৳</a>
...
@section('modal')
    ...
    @include('modals.commission_modal')
@endsection
...
@section('script')
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $("body").on("click",".add-commission",function(e){
                 e.preventDefault();
