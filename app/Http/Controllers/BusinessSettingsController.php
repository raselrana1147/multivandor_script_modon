...
class BusinessSettingsController extends Controller
{
    ...
    public function mobile_otp(){
        ...
        return view('backend.setup_configurations.mobile_otp')->with('data',$data);
    }

    public function update_mobile_otp(Request $request){
                $data=OTPMeta::find($request->id);
                $data->sender=$request->sender;
                $data->available_message=$request->available_message;
                $data->save();
