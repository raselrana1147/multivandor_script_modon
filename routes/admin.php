...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
   ...
   Route::post('/add-product-commission', 'ProductController@add_commission')->name('products.commission.add');
    ...
    Route::get('/general-setting', 'BusinessSettingsController@general_setting')->name('general_setting.index');
      ...
      Route::get('/mobil-otp', 'BusinessSettingsController@mobile_otp')->name('mobile_otp.index');
      Route::post('/mobil-otp', 'BusinessSettingsController@update_mobile_otp')->name('mobile.otp.update');
