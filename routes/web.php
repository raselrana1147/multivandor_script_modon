...
// mobile varification routes

    Route::get('/varify-mobile', 'Auth\MobileOTPController@show_form')->name('mobile.verification.form');
    Route::get('/reset_password', 'Auth\MobileOTPController@reset_form')->name('reset.password.otp');
    Route::post('/reset_password', 'Auth\MobileOTPController@update_pass_otp')->name('password.update.otp');
    Route::post('/varify-mobile', 'Auth\MobileOTPController@verify')->name('mobile.verification');
// end routes
...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::get('/today-sell-history', 'ReportController@today_sell')->name('today.sell');
});
